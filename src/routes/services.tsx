...
function ServiceCard({ pkg, idx }: { pkg: Pkg; idx: number }) {
  const base =
...
function ServicesPage() {
  return (
    <SiteLayout>
      <section id="services" className="relative overflow-hidden bg-black pt-40 pb-28">
        <img
          src={doodleMegaphone}
          alt=""
          aria-hidden
        ...
        <div className="container-x relative z-10">
          ...
          <div className="mt-16 grid auto-rows-fr gap-5 md:grid-cols-2 lg:grid-cols-6">
            {PACKAGES.map((p, i) => (
